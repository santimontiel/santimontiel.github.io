...
authors:
    ...
    - name: Miguel Antunes-García
      url: https://www.miguelantunes.eu/
      affiliation: 1
    - name: Fabio Sánchez-García
      url: https://www.linkedin.com/in/fabio-sanchez-garcia/
      affiliation: 1
    - name: Ángel Llamazares
      url: https://allamazares.jimdofree.com/
      affiliation: 1
    - name: Holger Caesar
      url: https://sites.google.com/it-caesar.de/homepage/
      affiliation: 2
    - name: Luis M. Bergasa
      url: http://www.robesafe.uah.es/personal/bergasa/
      affiliation: 1
affiliations:
...
links:
    paper: http://arxiv.org/abs/2602.08784
    code: https://github.com/santimontiel/gaussiancar
    weights: https://huggingface.co/santimontieleu/gaussiancar
announcement: '🏆 Accepted to IEEE ICRA 2026! See you in Vienna, Austria.'
---
