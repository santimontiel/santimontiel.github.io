...
description: 'End-to-end cameraradar BEV segmentation using Gaussian Splatting as a differentiable view transformer, achieving SOTA-level accuracy with 3.2x faster inference on nuScenes.'
pubDate: 'Jun 01 2026'
